...
public class HttpConnectUtils {
	...
	private static Logger log = Logger.getLogger(HttpConnectUtils.class);
	//socket超时，单位毫秒
	 ...
	 */
	public static String postRequest(String host, String jsonParam) {
		...
		for (int i = 0; i < 3; i++) {
			try {
				...
				log.info("响应状态：" + status.getStatusCode() + " 运行耗时：" + df.format((end - start)/1000.00) + "S 请求地址：" + host);
	 ...
	 * @throws MtripException
	 */
	public static String postRequest(String host, Map<String, String> param, boolean isForm) {
		DecimalFormat df = new DecimalFormat("######0.000");
		long start = System.currentTimeMillis();
		String result = "";
		CloseableHttpResponse response = null;
	 ...
	 * @throws MtripException
	 */
	public static HttpResponseVo postRequest(String host, String param, String contentType) {
		DecimalFormat df = new DecimalFormat("######0.000");
	 ...
	 * @throws MtripException
	 */
	public static String doGetRequest(String host) {
		DecimalFormat df = new DecimalFormat("######0.000");
		long start = System.currentTimeMillis();
		String result = "";
		CloseableHttpResponse response = null;
